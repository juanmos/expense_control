...
class DetalleComprasSriCommand extends Command
{
    ...
    public function handle()
    {
        ...
        foreach($compras as $compra){
            ...
            if($respAut->RespuestaAutorizacionComprobante->numeroComprobantes>0 &&  $respAut->RespuestaAutorizacionComprobante->autorizaciones->autorizacion->estado=='AUTORIZADO'){
                ...
                $json=array(
                    ...
                    "data"=>array(
                        "facturaNo"=> $array['infoTributaria']['estab'].'-'.$array['infoTributaria']['ptoEmi'] .'-'.$array['infoTributaria']['secuencial'],                                
