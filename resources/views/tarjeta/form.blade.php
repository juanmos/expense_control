    ...
    <div class="pcoded-wrapper">
        ...
        <div class="pcoded-content">
            <div class="pcoded-inner-content">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    @if($tarjeta!=null)
                                    <h5 class="m-b-10">Editar tarjeta</h5>
                                    @else
                                    <h5 class="m-b-10">Nuevo tarjeta</h5>
                                    @endif
                                </div>
                                <ul class="breadcrumb">
                ...
                <!-- [ breadcrumb ] end -->
                <form action="{{($tarjeta!=null)?route('institucion.alumno.tarjeta.update',[$id,$tarjeta->id]):route('institucion.alumno.tarjeta.store',$id)}}" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                    <input type="hidden" name="_method" value="{{($tarjeta!=null)?'PUT':'POST'}}"/>
