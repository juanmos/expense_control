                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="card card-event">
                                    <div class="card-block">
                                        ...
                                        {{-- <h2 class="mt-3 f-w-300">45<sub class="text-muted f-14">{{$hotel->direccion}}</sub></h2>
                            ...
                            <div class="col-xl-8 col-md-6">
                                <div class="card Recent-Users">
                                    <div class="card-header">
                                        <h5>Usuarios</h5>
                                        <a href="{{route('hotel.usuario.create',$hotel->id)}}" class="btn btn-primary float-right"><i class="fas fa-user-plus text-c-white f-10 m-r-15"></i> Nuevo usuario</a>
                                    </div>
                                            ...
                                            <table class="table table-hover">
                                                <tbody>
                                                    ...
                                                    <tr class="unread">
                                                        ...
                                                        <td><a href="{{route('hotel.usuario.edit',[$hotel->id,$usuario->id] )}}" class="label theme-bg text-white f-12">Editar</a></td>
                                                    </tr>
                                                    @empty
                                                    <p>No hay usuarios</p>
