        ...
        $('.getHistorial').on('click',function(){
            $.get('{{url("institucion/refrigerio/historial/pagos/")}}/'+$(this).attr('myid'),function(json){
                json.pagos.forEach(function(item){
                    var _pago = (item.factura!=null)?item.factura.factura_no:'Sin factura <br> <a href="#" data-toggle="modal" data-target="#facturarPagoModal" class="btn_facturar" myid="'+item.id+'">Facturar</a>';
